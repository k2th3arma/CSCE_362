...
public class Store {
	...
	public static int[] buttonID = { Value.airTowerLaser, Value.airAir, Value.airAir, Value.airAir, Value.airAir,
			Value.airAir, Value.airAir, Value.airTrashCan }; //Finds the values for the icons being placed in the store bar

	public static int[] buttonPrice = { 10, 0, 0, 0, 0, 0, 0, 0 }; // The cost of each of the boxes on the store bar
